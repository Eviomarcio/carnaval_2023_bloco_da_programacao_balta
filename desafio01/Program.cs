...
do
{
    ...
    (int contadorPalavras, int contadorCaracteres) = (entrada.Split(" ").Length, entrada.Length);

    Console.WriteLine($"O Texto possui {contadorPalavras} palavras e {contadorCaracteres} caracteres \n");
